...
function toggleVisitType(checkbox) {
    ...
    const message = isFirstTime 
        ...
        : "Oh great!! How was your previous trip then?";
...
function toggleChecklist() {
    var dropdown = document.getElementById("checklist-dropdown");
...
function toggleScript(id) {
    const allDropdowns = document.querySelectorAll('.script-dropdown');
    
    // Hide all other scripts first
...
function hardRestart() {
    ...
    // 2. Clear any scores or variables (if you have them)
    // score = 0; 

    // 3. Go back to the splash screen
    showPage('screen-splash');
}
